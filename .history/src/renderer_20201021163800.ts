...
const uploadFileWarning = document.getElementById("upload-file-warning") as any;
...
const updateNumberLines = () => {
    ...
    for (let i = 0; i < lines; i++) {
        const zeroFilled = ('0000'+i).slice(-4);
...
const updateMessages = () => {
    if (pdf) {
        console.log(uploadFileWarning);
        uploadFileWarning.alert('close');
    }
}
