...
// Action Handlers
const handleUploadPDF = () => pdf = uploadPDFInput.files[0];
const callUploadPDFInput = () => uploadPDFInput.click();

// Action Bindings
uploadPDFButton.addEventListener("click", callUploadPDFInput);
