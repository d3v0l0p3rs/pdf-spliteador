...
const setProgressBar = (percentage: number) => {
    const currentValue = parseInt((<any>$('.progress-bar')).css('width').slice(0, -1));
    console.log("currentValue1", (<any>$('.progress-bar')).css('width'))
    console.log("currentValue2", (<any>$('.progress-bar')).css('width').slice(0, -1))
    console.log("currentValue3", currentValue)
    console.log("currentValue3", percentage)
    if (currentValue && currentValue !== percentage) {
