...
// Action Bindings
numberLinesText.addEventListener('scroll', () => numberLinesText.scrollTop = nameLinesText.scrollTop, false);
...
uploadPDFInput.addEventListener("change", () => pdf = uploadPDFInput.files[0]);

nameLinesText.addEventListener('input', () => {
    console.log(nameLinesText.value.split(/\r\n|\r|\n/).length)
});
